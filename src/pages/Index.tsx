...
export default function Index() {
  ...
  const destinationButtonTextClass =
    destination ? 'text-gray-800' : 'text-gray-500';
  ...
  return (
    <div className="w-full">
      <div className="flex flex-col items-center p-6">
        ...
        <div className="flex w-full max-w-6xl items-center gap-4 rounded-full bg-white p-4 shadow-lg">
          {/* 목적지 */}
          <div className="flex flex-[0.5] items-center gap-2 px-4">
            ...
            <div ref={destinationDropdownRef} className="w-full min-w-0">
              ...
              <div className="relative flex items-center gap-1">
                <button
                  ...
                  className="flex w-fullmin-w-0 items-center justify-between gap-2 rounded-lg border border-white bg-white px-3 py-2 text-left text-sm font-medium transition hover:border-gray-300"
                >
                  <span
                ...
                {isDestinationDropdownOpen ? (
                  <div className="absolute left-0 top-full z-10 mt-2 w-full rounded-xl border border-gray-200 bg-white p-2 shadow-lg">
          ...
          <div className="flex flex-[0.5] items-center gap-2 px-4">
            ...
            <div className="w-full">
              ...
              <DatePicker
                ...
                className="w-full cursor-pointer rounded border-0 bg-transparent text-left text-sm font-medium text-gray-800 outline-none"
            ...
            <div className="w-full">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-14 rounded border border-white bg-transparent px-2 py-1 text-center text-sm font-medium text-gray-800 transition outline-none focus:border-primary"
                  aria-label="인원 수"
                />
                <button
                  type="button"
          ...
          {/* 테마 선택 */}
          <div className="relative flex flex-[0.3] items-center gap-2 px-4">
            <div ref={themeDropdownRef} className="w-full min-w-0">
              ...
              <div className="relative flex items-center gap-1">
                <button
                  ...
                  className="flex w-full max-w-34 min-w-0 items-center justify-between gap-2 rounded-lg border border-white bg-white px-3 py-2 text-left text-sm font-medium transition hover:border-gray-300"
                >
                  <span
                  ...
                  <div className="absolute top-full left-0 z-10 mt-2 w-full rounded-xl border border-gray-200 bg-white p-2 shadow-lg">
                    <div className="max-h-56 space-y-1 overflow-y-auto">
                      {themeOptions.map((theme) => (
                        <label
                          key={theme.value}
                          className="flex cursor-pointer items-center gap-2 rounded-lg px-2 py-2 text-sm text-gray-700 transition hover:bg-gray-50"
                        >
                          <input
                            type="checkbox"
          ...
          {/* 검색 버튼 */}
          <button className="btn flex h-12 w-12 shrink-0 items-center justify-center rounded-full border-none bg-primary p-0 text-white shadow-md hover:bg-primary-600">
            <Search size={20} />
          </button>
        </div>
      </div>
